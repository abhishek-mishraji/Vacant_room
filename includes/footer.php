  ...
  <footer class="site-footer">
      <div class="container footer-container">
          <div class="footer-branding">
              <svg class="footer-logo" width="32" height="32" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="footer-name">Find Vacant Room</div>
          </div>
          <div class="footer-info">
              <div class="footer-copyright">
                  <small>© <?= date('Y') ?> Find Vacant Room. All rights reserved.</small>
              </div>
  ...
  <div class="mobile-menu-overlay">
      <nav class="mobile-menu">
          ...
          <!-- Traffic Stats Link in Mobile Menu -->
          <a href="traffic_stats.php">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
