...
// Include traffic tracker if available
if (file_exists(__DIR__ . '/traffic_tracker.php')) {
...
<head>
    ...
    <link rel="icon" type="image/svg+xml"
        href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Crect x='12' y='24' width='40' height='28' rx='4' fill='%23e3f0ff' stroke='%23007bff' stroke-width='2'/%3E%3Crect x='28' y='16' width='8' height='8' fill='%23007bff' stroke='%23007bff' stroke-width='1'/%3E%3C/svg%3E">
    <style>
        .main-nav {
            display: flex;
        }
        ...
        <div class="container">
            <div class="header-flex-container">
                <div class="logo-container">
                    <svg class="logo-icon" width="24" height="24" viewBox="0 0 64 64" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect x="12" y="24" width="40" height="28" rx="4" fill="#e3f0ff" stroke="#ffffff"
                            stroke-width="2" />
                        <rect x="24" y="36" width="6" height="8" fill="#b3d1ff" stroke="#ffffff" stroke-width="1" />
                        <rect x="34" y="36" width="6" height="8" fill="#b3d1ff" stroke="#ffffff" stroke-width="1" />
                        <rect x="28" y="16" width="8" height="8" fill="#ffffff" stroke="#ffffff" stroke-width="1" />
                    </svg>
            ...
            <nav class="main-nav">
                ...
                <?php if (!empty($_SESSION['admin_username'])): ?>
                    ...
                    <a href="logout.php" class="nav-link">
                        ...
                        <span>Logout (<?= htmlspecialchars($_SESSION['admin_username']) ?>)</span>
                    </a>
                <?php else: ?>
